        ...
        style={{
          background: `
            linear-gradient(135deg, 
              rgba(5, 3, 1, 0.95) 0%,
              rgba(17, 8, 2, 0.95) 100%
            )
          `,
          backdropFilter: "blur(20px)",
          WebkitBackdropFilter: "blur(20px)",
          borderBottom: "1px solid rgba(255, 122, 24, 0.24)",
          boxShadow:
      ...
      >
        <div className="flex items-center justify-between px-6 py-4">
          ...
          <motion.div
            ...
            style={{
              background: "linear-gradient(135deg, #ffb15c 0%, #ff6a00 100%)",
              ...
              >
                ...
                <div
                  ...
                  style={{
                    ...
                    `,
                    borderRadius: "50%",
                    boxShadow: "0 0 10px rgba(255, 122, 24, 0.55)",
                    zIndex: 3,
                  }}
                />
